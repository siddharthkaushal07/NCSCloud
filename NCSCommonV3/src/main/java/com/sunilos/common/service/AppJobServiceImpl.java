...
import com.sunilos.common.dao.AppJobDAOInt;
...
@Service
@Transactional
public class AppJobServiceImpl extends BaseServiceImpl<AppJobDTO, AppJobDAOInt> implements AppJobServiceInt {

	private static Logger log = LoggerFactory.getLogger(AppJobServiceImpl.class);
